      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-6">
        ...
        <a href="#" className="group">
          <div className="flex items-baseline gap-1">
            <span className="font-serif text-2xl font-bold tracking-tight text-emerald-700">
              Podo
            </span>

            <span className="font-serif text-2xl font-bold tracking-tight text-[#315A72]">
              Care
            </span>
          </div>

          <p className="mt-0.5 text-[10px] font-semibold uppercase tracking-[0.18em] text-stone-500">
...
>
  {menuOpen ? <X size={25} /> : <Menu size={25} />}
        ...
        <a
          ...
          className="hidden rounded-full bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:bg-emerald-700 hover:shadow-md md:inline-flex"
        >
          Reservar
        </a>
        {/* Menú móvil */}
  ...
  <div className="absolute left-0 top-full w-full border-b border-stone-200 bg-white px-5 py-5 shadow-lg md:hidden">
    <nav className="flex flex-col gap-2">
      ...
      <a
        ...
        rel="noopener noreferrer"
        onClick={() => setMenuOpen(false)}
        className="mt-2 rounded-full bg-emerald-600 px-5 py-3 text-center font-semibold text-white shadow-md transition hover:bg-emerald-700"
      >
